window.CollisionDetector = class CollisionDetector {
    static detectWallCollision(ball, wallWidth, canvasWidth, canvasHeight) {
    ...
    static detectRacketCollision(ball, racket) {
        if (
